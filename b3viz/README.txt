...
At Primitive resolution, newly flipped bit positions are sonified as notes. Each
byte maps its eight bits to eight distinct pitch classes; the word's four bytes
occupy four registers. All G calls rotate the shared octatonic pitch field
C, D, E-flat, F, F-sharp, A-flat, A, B. Vertical G roots expose major thirds;
diagonal G roots expose minor thirds. ADD, XOR, and ROTATE retain distinct
sawtooth, square, and triangle timbres.
